...
class PetFriends:
    ...
    def add_create_pet_simple(self, auth_key: json, name: str, animal_type: str,
                    age: str) -> json:
    ...
    def add_new_pets_set_photo(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """Метод отправляет (постит) на сервер данные о добавляемом фото питомца и возвращает статус
        запроса на сервер и результат в формате JSON с фото добавленного питомца"""
